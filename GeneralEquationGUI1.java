...
public class GeneralEquationGUI1 extends JFrame {
    ...
    public GeneralEquationGUI1() {
        ...
        JLabel titleLabel = new JLabel("<html><h1 style='color: #0000FF;'>Rotated Equation To Original Equation</h1></html>");
    ...
    private void rotateEquation() {
        try {
            ...
            double third = (a * sin2T) - (b * sin2T) + (2 * h * cos2T);
            double fourth = (-2 * g * sinT) + (2 * f * cosT);
            double five = (2 * g * cosT) + (2 * f * sinT);
